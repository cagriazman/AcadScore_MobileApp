...
const Sayfa7 = () => {
  ...
  const {tumKayitlariSil,hesaplaAkademikTesvikPuan,tumKayitlariSilSayfa7,alan, kayitlarSayfa7, toplamPuanSayfa7, kayitEkleSayfa7, kayitSilSayfa7 } = useContext(KayitContext);
  
const handleKaydet1 = () => {kayitEkleSayfa7
  ({kisiSayisi:kisiSayisi1, adet: adet1, oran:100 },() => setModal1Visible(false));};
  const handleKaydet2 = () => {kayitEkleSayfa7
  ({ kisiSayisi:kisiSayisi2,adet: adet2, oran:60 },() => setModal2Visible(false));};
...
const [kisiSayisi2, setKisiSayisi2] = useState('');
...
<View style={styles.container}>
  ...
  <View style={{ backgroundColor: '#1976d2', padding: 10, borderRadius: 10, marginVertical: 20 }}>
    <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'white' }}>6. Patent (30 puan)</Text>
  </View>
  

  <View style={styles.satirStil}>
    <Text style={styles.metinStil} numberOfLines={2}>
6.1. Uluslararası patent	
    </Text>
...
6.2. Ulusal patent	
  ...
  <View style={{ marginVertical: 20, width: '90%' }}>
    ...
    {kayitlarSayfa7.length === 0 && <Text>Henüz puan eklenmedi.</Text>}
    {kayitlarSayfa7.map((k, index) => (
      ...
      <TouchableOpacity onPress={() => kayitSilSayfa7(index)} style={{
...
<View style={{
  ...
  <Text style={{
    ...
    Toplam Puan: {toplamPuanSayfa7.toFixed(2)}
  </Text>
</View>

<View style={styles.butonContainer}>
          <TouchableOpacity style={styles.butonTemizle} onPress={tumKayitlariSilSayfa7}>
