...
const Sayfa5 = () => {
  ...
  const {tumKayitlariSil,hesaplaAkademikTesvikPuan,tumKayitlariSilSayfa5,alan, kayitlarSayfa5, toplamPuanSayfa5, kayitEkleSayfa5, kayitSilSayfa5 } = useContext(KayitContext);
  
const handleKaydet1 = () => {kayitEkleSayfa5
  ({ adet: adet1, oran:15 },() => setModal1Visible(false));};
...
<View style={styles.container}>
  ...
  <View style={{ backgroundColor: '#1976d2', padding: 10, borderRadius: 10, marginVertical: 20 }}>
    <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'white' }}>4. Tasarım (15 puan)</Text>
  </View>
  

  <View style={styles.satirStil}>
    <Text style={styles.metinStil} numberOfLines={4}>
    4.1. Endüstriyel, çevresel (bina, peyzaj ve iç mekan) veya grafiksel tasarım; sahne, moda (kumaş, aksesuar veya giysi tasarımı) veya çalgı tasarımı	
    </Text>
  ...
  <View style={{ marginVertical: 20, width: '90%' }}>
    ...
    {kayitlarSayfa5.length === 0 && <Text>Henüz puan eklenmedi.</Text>}
    {kayitlarSayfa5.map((k, index) => (
      ...
      <TouchableOpacity onPress={() => kayitSilSayfa5(index)} style={{
...
<View style={{
  ...
  <Text style={{
    ...
    Toplam Puan: {toplamPuanSayfa5.toFixed(2)}
  </Text>
</View>

        <View style={styles.butonContainer}>
          <TouchableOpacity style={styles.butonTemizle} onPress={tumKayitlariSilSayfa5}>
